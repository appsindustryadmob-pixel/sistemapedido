...
<div class="content">
    <div class="form-container">
        ...
        <label for="fecha-entrega">Fecha de Inventario:</label>
        ...
        <form action="enviar_correo.php" method="post">
            ...
            <button type="button" id="agregar-producto">Agregar al Inventario</button>
        </form>
    </div>
    ...
    <div class="order-summary" id="resumen-pedido">
        ...
        <button type="button" id="guardar-enviar-btn">Guardar y Enviar inventario</button>
    </div>

    <div class="pedido-enviado" id="pedido-enviado">
        <h2>Inventario Enviado</h2>
        <div id="pedido-enviado-fecha"></div>
        <ul id="pedido-enviado-lista"></ul>
        <button type="button" id="nuevo-pedido-btn">Realizar Nuevo Inventario</button>
    </div>
</div>
...
<script>
    ...
    if (fechaEntrega === '') {
        alert('Por favor, ingrese la fecha del Inventario.');
    ...
    if (producto !== '') {
        ...
        guardarEnviarBtn.addEventListener('click', function () {
            ...
            xhr.open('POST', 'guardar_inventario.php', true);
        ...
        function agregarProductoAlPedido(producto, unidad, cantidad, comentario) {
            if (resumenFechaEntrega.innerHTML === '' && fechaEntregaInput.value !== '') {
                resumenFechaEntrega.textContent = 'Fecha de Entrega: ' + fechaEntregaInput.value;
            }
